...
urlpatterns = [
    ...
    path("quizzes/<int:quiz_id>/detail/", QuizDetailView.as_view(), name="quiz-detail"),
    path("quizzes/<int:quiz_id>/submit/", SubmitQuizByIdView.as_view(), name="quiz-submit-by-id"),
    path("tasks/<int:task_id>/detail/", TaskDetailView.as_view(), name="task-detail"),
    path("tasks/<int:task_id>/submit/", SubmitTaskByIdView.as_view(), name="task-submit-by-id"),
